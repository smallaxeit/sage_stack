...
Source PDFs for the knowledge base. Primary source: books.google.com

---

## Religious Texts (loaded)
- [x] The Holy Bible (KJV)
- [x] Ethiopian Orthodox Bible
- [x] Torah
- [x] Quran (ClearQuran English translation)
- [x] The 4 Vedas
...
## Social Contract (scripture → social contract)
...
- books.google.com → search title → Download PDF (public domain works are free)
- Project Gutenberg (gutenberg.org) is also a clean source for public domain texts
